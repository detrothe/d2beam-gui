...
export class drButtonPM extends LitElement {
  ...
  render() {
    return html`
      ...
      <button id="id_input_node_dec" class="spinner decrement" @click="${this._decrement_nnodes}">
        -</button
      ><input
        type="number"
        step="1"
      ...
      /><button id="id_input_node_incr" class="spinner increment" @click="${this._increment_nnodes}">
        +
      </button>
    `;
  }
