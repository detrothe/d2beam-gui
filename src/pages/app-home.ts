...
export class AppHome extends LitElement {
   ...
   _neuZeilen() {
      ...
      if (shadow) {
         ...
         const table = el?.shadowRoot?.getElementById(
            'mytable'
         ) as HTMLTableElement;
         ...
         for (let i = 0; i < nnodes; i++) {
            ...
            console.log('NODE i:1', i, child.value);
            //wert = child.value;
            child = table.rows[i + 1].cells[2]
               .firstElementChild as HTMLInputElement;
            //wert = child.value;
            console.log('NODE i:2', i, child.value);
         }
      }
   }
            ...
            <div id="welcomeBar">
               <dialog id="dialog">
                  ...
                  <sl-tab-group>
                     ...
                     <sl-tab slot="nav" panel="tab-querschnitt"
                        >Querschnitt</sl-tab
                     >
                     ...
                     <sl-tab-panel name="tab-material">
                        ...
                        <input id="bettung" type="number" /> &nbsp;[kN/m²]
                        <br />
