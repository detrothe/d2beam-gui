...
["_cmult","_malloc","_free","_c_d2beam1","_fflush","onRuntimeInitialized"].forEach((prop) => {
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'd2beam_wasm.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('d2beam_wasm.wasm', import.meta.url).href;
}
...
/** @type {function(...*):?} */
var _cmult = Module["_cmult"] = createExportWrapper("cmult");
/** @type {function(...*):?} */
